...
const FlightSearch = () => {
  ...
  const handleFilterByAirline = (airline) => {
    if (airline === "") {
      // If "All Airlines" is selected, show all flights
      setFilteredFlights(flights);
    } else {
      // Otherwise, filter flights by the selected airline
      const filtered = flights.filter((flight) => flight.airline === airline);
      setFilteredFlights(filtered);
    }
  };
  ...
  const handleSortByPrice = () => {
    ...
    // Sort flights based on sort direction
    ...
    <>
      <div className="header">
        <nav className="header-nav">
          <a href="/" className="header-logo">Flight Booking</a>
